...
{'tb_assessment':'select ass.id,ass.name,ass.typ,ass.programme_id,ass.start_date,ass.end_date from schools_assessment ass,schools_programme p where ass.programme_id=p.id and p.id in (1,2,3,5,6,7,8,9,14,15,18,19,23,24,25,26,27,28,29,30,31,37,39,38,35,34,32,41,36,33,45,44,49,48,47,43,42,46)'},
